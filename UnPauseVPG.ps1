...
<#
.SYNOPSIS
This script is designed to unpause a VPG.
.DESCRIPTION
This script can be used to schedule an unpausing of a paused VPG. Often used in conjuction with the PauseVPG script in a schedule.
.EXAMPLE
